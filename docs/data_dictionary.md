...
## 🏢 Platform: CyberShield: Enterprise Cybersecurity & SOC Operations Analytics
**Schema**: `cybershield_dw`  
...
### 2. `dim_endpoints`
Dimensional attribute master for Endpoints.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `endpoints_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `endpoints_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
...
### 2. `dim_mitre_tactics`
Dimensional attribute master for Mitre Tactics.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `mitre_tactics_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `mitre_tactics_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_analysts`
Dimensional attribute master for Analysts.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `analysts_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `analysts_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### 2. `dim_threat_actors`
Dimensional attribute master for Threat Actors.

| Column Name | Data Type | Nullable | Key | Description |
|---|---|:---:|:---:|---|
| `threat_actors_key` | SERIAL / INT | NO | PK | Surrogate primary key |
| `threat_actors_code` | VARCHAR(32) | NO | UNIQUE | Natural business identifier code |
| `name` | VARCHAR(100) | NO | - | Canonical entity name |
| `category` | VARCHAR(50) | NO | - | Operational classification category |
| `status_tier` | VARCHAR(20) | NO | - | Operational state (ACTIVE, INACTIVE, SUSPENDED) |
| `created_at` | TIMESTAMP | NO | - | System ingestion audit timestamp |
...
### `fact_siem_alerts`
Transactional and snapshot grain telemetry table tracking Siem Alerts.
...
### `fact_incident_investigations`
Transactional and snapshot grain telemetry table tracking Incident Investigations.
...
### `fact_vulnerability_scans`
Transactional and snapshot grain telemetry table tracking Vulnerability Scans.
...
### `fact_firewall_blocks`
Transactional and snapshot grain telemetry table tracking Firewall Blocks.
